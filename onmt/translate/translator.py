...
class Translator(Inference):
    ...
    def _translate_batch_with_strategy(self, batch, decode_strategy):
        ...
        # ### new adding
        # import joblib
        # joblib.dump(decode_strategy.beam_data, "/home/zhangwei/smiles_edit/inference_code/beam_data_12_17_e_smiles.pkl")
        # # joblib.dump(dec_outs, "/home/house3/zhangwei/smiles_edit/inference_code/dec_outs_embedding_12_14.pkl")
